...
def infer_image(pil_image, bbox, temperature):
    # Recadrer l'image pour correspondre à la zone sélectionnée
    input_img = pil_image.crop(bbox)
    # Appliquer un zoom 2x avant l'analyse OCR
    input_img = input_img.resize((input_img.width * 2, input_img.height * 2), Image.Resampling.LANCZOS)
